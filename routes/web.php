...
Route::middleware(['auth', 'verified', 'ensure-activated', 'ensure-has-team'])->group(function () {
    ...
    Route::middleware('ensure-server-ready')->group(function () {
        ...
        Route::patch('agents/{agent}/email/gmail', [AgentController::class, 'updateGmailSettings'])->name('agents.email.gmail');
        ...
        Route::post('agents/{agent}/chat/server-sessions/sync', [ChatController::class, 'syncServerSessions'])->name('agents.chat.server-sessions.sync');
        Route::post('agents/{agent}/chat/server-sessions/{discovery}/import', [ChatController::class, 'importServerSession'])->name('agents.chat.server-sessions.import');
