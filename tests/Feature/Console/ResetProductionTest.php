...
test('production reset aborts before releasing servers when artifact DNS cleanup fails', function () {
    ...
    $this->artisan('app:reset-production')
        ->expectsOutputToContain('DNS cleanup unavailable')
